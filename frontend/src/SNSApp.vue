    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'inputInfos', 
                route: '/registrations/inputInfos',
                ImageUrl: '',
            },
            { 
                title: 'icmpData', 
